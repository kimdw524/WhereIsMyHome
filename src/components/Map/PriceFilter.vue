...
for (let i = 0; i <= 4; i++)
  highPrice.push({ value: i * 100, name: `${moneyFormat(i * 1_000_000)}` });
...
for (let i = 0; i <= 9; i++) lowPrice.push({ value: i * 5, name: `${moneyFormat(i * 50_000)}` });
for (let i = 10; i <= 18; i += 2)
  lowPrice.push({ value: i * 5, name: `${moneyFormat(i * 50_000)}` });
